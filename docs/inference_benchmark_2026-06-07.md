...
cmake --build controller_cpp/build_z1 --target onnx_benchmark
```

Commands:

```bash
/home/hiyio/anaconda3/envs/robomimic/bin/python python_reference/tools/onnx_benchmark.py \
  --model policies/loco_mode/model/z1_flat_8192_rootheight_model_2700.onnx \
